...
namespace Raspware.ExampleGame.Stage.RayCasterAdditional
{
	public sealed class Camera
	{
		...
		public double LightRange { get; set; }
		...
		private void DrawSky(double direction, Bitmap skyBox, double light)
		{
			/*
		...
		private void DrawWeapon(Bitmap Weapon, double paces)
		{
		...
		private void DrawColumn(double column, Origin[] Ray, double angle, Map map)
		{
			/*var ctx = this.ctx;
		...
		{
			public Project(double height, double angle, double distance) {
				/*
